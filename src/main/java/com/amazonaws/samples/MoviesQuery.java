...
public class MoviesQuery {
    ...
    public static void main(String[] args) throws Exception {
    	...
    	try {
    		...
    		throw new AmazonClientException("yeah" + e);
    	}
    	
        AmazonDynamoDB client = AmazonDynamoDBClientBuilder.standard()
                .withCredentials(credentialsProvider).withRegion("us-east-2").build();
        ...
        try {
            System.out.println("Movies from 2003");
